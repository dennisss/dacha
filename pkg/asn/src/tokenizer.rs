...
const RESERVED_WORDS: &'static [&'static [u8]] = &[
	b"ABSENT", b"ABSTRACT-SYNTAX", b"ALL", b"APPLICATION", b"AUTOMATIC", b"BEGIN", b"BIT", b"BMPString", b"BOOLEAN", b"BY", b"CHARACTER", b"CHOICE", b"CLASS", b"COMPONENT", b"COMPONENTS", b"CONSTRAINED", b"CONTAINING", b"DATE", b"DATE-TIME", b"DEFAULT", b"DEFINITIONS", b"DURATION", b"EMBEDDED", b"ENCODED", b"ENCODING-CONTROL", b"END", b"ENUMERATED", b"EXCEPT", b"EXPLICIT", b"EXPORTS", b"EXTENSIBILITY", b"EXTERNAL", b"FALSE", b"FROM", b"GeneralizedTime", b"GeneralString", b"GraphicString", b"IA5String", b"IDENTIFIER", b"IMPLICIT", b"IMPLIED", b"IMPORTS", b"INCLUDES", b"INSTANCE", b"INSTRUCTIONS", b"INTEGER", b"INTERSECTION", b"ISO646String", b"MAX", b"MIN", b"MINUS-INFINITY", b"NOT-A-NUMBER", b"NULL", b"NumericString", b"OBJECT", b"ObjectDescriptor", b"OCTET", b"OF", b"OID-IRI", b"OPTIONAL", b"PATTERN", b"PDV", b"PLUS-INFINITY", b"PRESENT", b"PrintableString", b"PRIVATE", b"REAL", b"RELATIVE-OID", b"RELATIVE-OID-IRI", b"SEQUENCE", b"SET", b"SETTINGS", b"SIZE", b"STRING", b"SYNTAX", b"T61String", b"TAGS", b"TeletexString", b"TIME", b"TIME-OF-DAY", b"TRUE", b"TYPE-IDENTIFIER", b"UNION", b"UNIQUE", b"UNIVERSAL", b"UniversalString", b"UTCTime", b"UTF8String", b"VideotexString", b"VisibleString", b"WITH",
	
	// Deprecated words
	b"ANY", b"DEFINED", b"BY"
];
...
impl Token {
	...
	// TODO: Same thing as typereference except diffent first character capitalization
	...
	// TODO: simplestring can only contain ASCII visible characters and can't contain
	// an escaped quotation mark. cstring can be unicode
...
mod tests {
	...
	// 	// let mut file = std::fs::File::open("/home/dennis/workspace/dacha/pkg/crypto/src/asn/asn.grammar").unwrap();
	// 	// let mut data = vec![];
	// 	// file.read_to_end(&mut data).unwrap();

	// 	let (tokens, _) = complete(many(parse_token))(Bytes::from(TEST_SCHEMA)).unwrap();
