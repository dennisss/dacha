...
/// 
/// This is a non-cryptographically secure hashing function meant for collision avoidance and speed more than anything else.
...
pub fn Fingerprint2011(bytes: &[u8]) -> u64 {
