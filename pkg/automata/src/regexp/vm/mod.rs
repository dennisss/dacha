...
mod tests {
    ...
    // TODO: We don't want '.' to match the empty string (given that it will match the start marker)

    // All user provided regular expressions will be executed as if they are actually
    // ".*R" where "R" is the user input expression.
