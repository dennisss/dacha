...
/// Represents a synchronous stream interface similar in purpose to the futures main
pub trait Stream {
	/// NOTE: The 'max' argument is voluntary and is mainly meant to guide blocking reads as the consumer will be totally happy with stopping as soon as it is done
