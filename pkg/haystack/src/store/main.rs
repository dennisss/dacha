...
pub async fn run(dir: Directory, port: u16, folder: &str) -> Result<()> {
	...
	// TODO: Ideally this should start running at the same time as the HTTP2 serving shutting down
	// as we probably need some unified shutdown mechanism for servers.
