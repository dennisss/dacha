...
pub struct ServerProgress {
    ...
    /// request) TODO: Per section 6.2 of the thesis, a leader should
    ...
    /// Main issue being that this will become trickier in the case of pipelined
    /// messages
    pub last_sent: Option<Instant>,

    /// Whether or not we are currently waiting for a response on an active
    /// request
