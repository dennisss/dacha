...
The output of this is `third_party/ar0234-v4l2-driver/build/out.tar.gz`

Copy it to the pi-gen directory as follows:

```
mkdir -p third_party/pi-gen/data
cp third_party/ar0234-v4l2-driver/build/out.tar.gz third_party/pi-gen/data/ar0234.tar.gz
```
...
```
TIME=$(date +%Y-%m-%d)
gsutil cp "third_party/ar0234-v4l2-driver/build/out.tar.gz" "gs://da-manual-us/rpi-ar0234-builds/$TIME/ar0234.tar.gz"
```